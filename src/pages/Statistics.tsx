    ...
    <DashboardLayout>
      <div className="p-4 md:p-6 lg:p-8 animate-fade-in">
        <div className="mb-6 md:mb-8 flex items-center gap-3 md:gap-4 pb-4 border-b border-border">
          ...
          <div>
            <h2 className="text-xl md:text-3xl font-bold text-foreground">Statistics</h2>
            <p className="text-xs md:text-sm text-muted-foreground font-medium">Home / Master Data / Statistics</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <StatCard
            ...
            onClick={() => navigate("/escrow-account")}
          />
